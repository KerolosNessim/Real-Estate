...
const EstateCard = ({ withBorder = true }) => {
  return (
    <div className={`${withBorder && "border-2 border-gray-200"} bg-white rounded-lg p-4 space-y-5`}>
      ...
      {/* link */}
      <Link href={'/states/1'} className='text-sm font-medium block text-center w-3/4 mx-auto  rounded-md  py-2 px-3 border-1 border-main-green text-main-green hover:bg-main-green hover:text-white transition-all duration-300'>عرض السعر</Link>
    </div>
  )
}
