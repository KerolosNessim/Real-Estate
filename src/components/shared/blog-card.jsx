...
const BlogCard = () => {
  return (
    <article className='border-2 border-gray-200 rounded-s-2xl overflow-hidden'>
      ...
      <Link href='/blog/1' className='block w-fit rounded-full  py-2 px-3 border-1 border-main-green text-main-green hover:bg-main-green hover:text-white transition-all duration-300'><MdArrowForwardIos size={14} /></Link>
      </figcaption>
